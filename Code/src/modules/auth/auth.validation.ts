...
export const LoginGQL = z.strictObject({
  email: generalValidationFields.email,
  password: generalValidationFields.password,
  FCM: z.string().optional(),
});
export const SignUpGQL = z
  .strictObject({
    email: generalValidationFields.email,
    password: generalValidationFields.password,
    FCM: z.string().optional(),
...
export const ConfirmOTPGQL = z.strictObject({
  email: generalValidationFields.email,
  otp: generalValidationFields.otp,
});
export const ForgetPasswordGQL = z.strictObject({
  email: generalValidationFields.email,
  phone: generalValidationFields.phone.optional(),
});
export const ResendConfirmEmailGQL = z.strictObject({
  email: generalValidationFields.email,
});
export const ResetPasswordGQL = z.strictObject({
  email: generalValidationFields.email,
  password: generalValidationFields.password,
});
