...
export class S3Service {
    ...
    async createPreSignedFetchLink({Bucket = AWS_BUCKET_NAME , Key , expiresIn = AWS_EXPIRES_IN , fileName , download}:{ Bucket? : string , Key : string  , expiresIn? : number , fileName? : string | undefined , download? : string | undefined}) : Promise<string>{
