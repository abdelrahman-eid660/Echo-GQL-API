...
exports.postSchema = exports.PostSchema = void 0;
const post_resolver_1 = require("./post.resolver");
const PostGQLTypes = __importStar(require("./post.types.gql"));
const PostGQLArgs = __importStar(require("./post.args.gql"));
class PostSchema {
    postResolver;
    constructor() {
